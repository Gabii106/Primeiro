...
// // export function filterPersons(persons: Person[], personType: string, criteria: User | Admin): Person[] {
// //     return persons
...
// const Algo = <R>(obj: R) => Object.keys(obj) as (keyof R)[];
...
//         .filter((person) => person.type === personType)
//         .filter((person) => {
//             let criteriaKeys = Algo(criteria);
//             return criteriaKeys.every((fieldName) => {
//                 return person[fieldName] === criteria[fieldName];
//             });
//         });
